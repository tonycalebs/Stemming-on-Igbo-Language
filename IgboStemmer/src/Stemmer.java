...
public class Stemmer {
  ...
  private static String stripPrefixes ( String str) {
     ...
     String[] prefixes = { "kilo", "micro", "milli", "intra", "ultra", "mega", "nano", "pico", "pseudo", "inter"};
  ...
  public static String stripAffixes( String str ) {
   ...
   public static void main(String [] args){
        String a = stripPrefixes("interdenominational");
        String b = stripSuffixes("interdenominational");
        String c = stripAffixes("interdenominational");
